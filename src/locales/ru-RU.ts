export default {
  common: {
    ...
    failed: 'Не удалось',
    verify: 'Проверить',
    unauthorizedTips: 'Введите код активации, после подтверждения вы сможете продолжить использование.',
  },
  chat: {
    newChatButton: 'Новый чат',
    placeholder: 'Спросите меня о чем-нибудь ... (Shift + Enter = перенос строки, "@" для вызова подсказок)',
    placeholderMobile: 'Спросите меня о чем-нибудь ...("@" для вызова подсказок)',
    copy: 'Копировать',
    copied: 'Скопировано',
